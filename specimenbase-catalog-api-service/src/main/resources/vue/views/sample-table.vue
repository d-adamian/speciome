            ...
            saveEdit() {
                ...
                .then(response => {
                    if (response.status == 200) {
                        ...
                        const updatedSample = {sampleId: res.sampleId};
                        res.attributes.forEach(attrValuePair => {
